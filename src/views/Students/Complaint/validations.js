    ...
    newComplaint: function validateComplaint(complaint) {
        ...
        if(complaint){
            ...
            if(complaint.relationshipAggresor){
                ...
                }else if(!checkInputs.isAlphanumeric(complaint.relationshipAggresor)){
        ...
        if (data.user) {
            ...
            if (user.cellphone) {
                if (!checkInputs.notNull(user.cellphone)) {
                    ...
                    errors.cellphone = "Solo ingrese los 10 digitos o 13 si el número es extrangero."
                }
            } else {
                errors.cellphone = "El número celular es necesario."
            }
            ...
            if (user.idUserESPE) {
                if (!checkInputs.notNull(user.idUserESPE)) {
                    ...
                    errors.idUserESPE = "El Id no tiene el formato correcto, ejemplo:  L00000001"
                } else if (user.idUserESPE.length !== 9  ) {
                    errors.idUserESPE = "ID invalido, el proporcionado tiene el formato: L00000001."
                }
            } else {
                errors.idUserESPE  = "Ingrese el Id proporcionado por la Universidad."
            }
            ...
            if (user.numDocument) {
                ...
                } else if (!checkInputs.isAlphanumeric(user.numDocument)) {
                    errors.numDocument = "No ingrese caracteres especiales."
            ...
            if (user.relationshipUniversity) {
                if (!checkInputs.notNull(user.relationshipUniversity)) {
                    errors.relationshipUniversity = "Ingrese la relación que tiene con la universidad."
