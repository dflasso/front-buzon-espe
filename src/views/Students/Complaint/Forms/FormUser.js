...
const FromUser = ({ user, onChange, errorsMsg }) => {
        ...
        .catch((exception) => {
          if (exception.response) {
            setAlert({
              show: true,
              msg:
                "Error al consultar los departamentos. Contáctese con soporte.",
              type: "alert alert-danger",
            });
          } else {
            setAlert({
              show: true,
              msg: "Error en la red. Contáctese con soporte.",
              type: "alert alert-danger",
            });
          }
        });
        ...
        .catch((exception) => {
          if (exception.response) {
            setAlert({
              show: true,
              msg:
                "Error al consultar las modalidades. Contáctese con soporte.",
              type: "alert alert-danger",
            });
          } else {
            setAlert({
  ...
  const getCarrers = useCallback(async () => {
    setOpenLoader(true);
    await clientBackendHeroko
      .get(`/v1/carrer/get-by/${departmentSelected}/${modalitySelected}`)
      .then((response) => {
        if (response.status >= 200 && response.status <= 300) {
      ...
      .catch((exception) => {
        if (exception.response) {
          setAlert({
            show: true,
            msg: "Error al consultar las carreras. Contáctese con soporte.",
            type: "alert alert-danger",
          });
        } else {
          setAlert({
  ...
  const checkData = (allData) => {
    ...
    if (Object.keys(newErrors).length === 0) {
        console.log(allData)
        if(typeof allData.carrer !== "string"){
            onChange(allData);
        }else{
            onChange({...allData,
                carrer:{
  ...
  const renderInputCarrer = () => {
    if (departmentSelected && modalitySelected) {
      return (
        ...
        >
          {carrers.map((item) => (
            <MenuItem value={item.idCarrer} key={item.idCarrer}>
              {item.description}
            </MenuItem>
          ))}
        </Select>
  ...
  const renderForm = () => {
    return (
      <Grid container spacing={2} justify="flex-start" alignItems="center">
        ...
        <Grid item xs={2}>
          <label>
            Apellidos: <font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={3}>
          <input
        ...
        <Grid item xs={3}>
          <label>
            Nombres: <font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={3}>
          <input
        ...
        <Grid item xs={2}>
          <label>
            Nacionalidad:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={3}>
          <input
        ...
        <Grid item xs={3}>
          <label>
            No. de Cédula de Identidad o Pasaporte:
            <font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={2}>
          <input
        ...
        <Grid item xs={1}>
          <label>
            Discapacidad:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={2}>
          <Select
        ...
        <Grid item xs={2}>
          <label>
            Dirección Domiciliaria:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={9}>
          <input
          ...
          />
          <small>
            Ingrese la parroquía, ciudad, sector, calle principal, calle
            secundaria y la numeración de domicilio.
          </small>
          <br />
        ...
        <Grid item xs={2}>
          <label>
            Fecha de de Nacimiento:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={4}>
          <input
          ...
          />
          <ErrorMsg
            reference={errors.placeDateBirth}
            msg={errors.placeDateBirth}
          />
        </Grid>
        <Grid item xs={2}>
          <label>
            Estado Civil:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={3}>
          <Select
        ...
        <Grid item xs={2}>
          <label>
            Etnia a la que pertenece:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={4}>
          <Select
        ...
        <Grid item xs={2}>
          <label>
            Relación con la Universidad:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={4}>
          <Select
          ...
          <ErrorMsg
            reference={errors.relationshipUniversity}
            msg={errors.relationshipUniversity}
          />
        </Grid>
        <Grid item xs={2}>
          <label>
            ID:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={3}>
          <input
          ...
          <>
            {nameCarrer ? (
              <>
                <Grid item xs={2}>
                  <label>
                    Carrera:<font color="#d50000">*</font>
                  </label>
                </Grid>
                <Grid item xs={4}>
                  <em>{nameCarrer}</em>
              ...
              <>
                <Grid item xs={2}>
                  <label>
                    Modalidad:<font color="#d50000">*</font>
                  </label>
                </Grid>
                <Grid item xs={4}>
                  <Select
                  ...
                  >
                    {modalities.map((item) => (
                      <MenuItem value={item.idModality} key={item.idModality}>
                        {item.description}
                      </MenuItem>
                    ))}
                  </Select>
                ...
                <Grid item xs={2}>
                  <label>
                    Departamento:<font color="#d50000">*</font>
                  </label>
                </Grid>
                <Grid item xs={3}>
                  <Select
            ...
            <Grid item xs={2}>
              <label>
                Período que cursa:<font color="#d50000">*</font>
              </label>
            </Grid>
            <Grid item xs={3}>
              <Select
              ...
              <ErrorMsg
                reference={errors.currentLevel}
                msg={errors.currentLevel}
              />
            </Grid>
          </>
        ) : null}
        ...
        <Grid item xs={2}>
          <label>
            Teléfono celular:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={3}>
          <input
        ...
        <Grid item xs={2}>
          <label>
            Teléfono convencional:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={4}>
          <input
          ...
          />
          <ErrorMsg
            reference={errors.conventionalTelephone}
            msg={errors.conventionalTelephone}
          />
        </Grid>
        <Grid item xs={2}>
          <label>
            Correo institucional:<font color="#d50000">*</font>
          </label>
        </Grid>
        <Grid item xs={3}>
          <input
